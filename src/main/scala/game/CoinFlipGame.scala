...
class CoinFlipGame(parentInput: TwitchInput, output: TwitchOutput, twitchConnection: TwitchConnection, channel: String) extends TwitchConsumer {
  ...
  var playerWins = 0 //TODO is there a way to track the score without var?
  var playerLosses = 0
